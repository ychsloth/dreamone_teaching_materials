...
function DrivePdfViewer({ category, recordId, watermark, pageNumber, onNumPages, session, pageWidth }) {
  ...
  return (
    <div className="relative bg-black flex flex-col items-center justify-center overflow-auto" style={{ minHeight: 420 }}>
      ...
      {watermark && (
        <div className="absolute inset-0 pointer-events-none select-none flex flex-col justify-around opacity-[0.5] overflow-hidden">
    ...
    <div className="fixed inset-0 bg-black/90 z-[350] flex items-center justify-center p-1.5">
      <div className="bg-[var(--card)] border-2 border-[#00ff88] cyber-chamfer w-full h-full max-w-[99vw] max-h-[99vh] flex flex-col shadow-[0_0_30px_rgba(0,255,136,0.25)]">
        ...
        <div className="flex-1 overflow-auto">
          <DrivePdfViewer category={category} recordId={file.id} watermark={watermark} pageNumber={page} onNumPages={setNumPages} session={session} pageWidth={1300} />
        </div>
        {numPages > 0 && (
