...
function VersionedFileBlock({ title, icon: Icon, files, comments, canManage, canPublish, onAdd, onEdit, onDelete, onComment, onPublish, commentsLoading, resolveAuthorName, commentField }) {
    ...
    <div className="bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-5 ">
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        ...
        {canManage && (
          <button
            onClick={onAdd}
            className="flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider border-2 border-[#00ff88] text-[#00ff88] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition"
          >
            ...
            <div key={f.id} className={`border cyber-chamfer-sm p-4 bg-[var(--muted)] ${f.is_public ? 'border-[#00ff88]' : 'border-[var(--border)]'}`}>
              {isEditing ? (
                <div className="space-y-2">
                  ...
                  />
                  <div className="flex gap-2">
                    <button onClick={saveEdit} className="flex-1 border-2 border-[#00ff88] text-[#00ff88] bg-transparent text-sm font-mono uppercase tracking-wider py-2 cyber-chamfer-sm hover:bg-[#00ff88] hover:text-[#0a0a0f] transition">儲存</button>
                  ...
                  <a href={f.file_url} target="_blank" rel="noreferrer" className="flex items-center gap-2 min-w-0 hover:text-[#00ff88] transition">
                    ...
                    <div className="min-w-0">
                      <p className="text-base font-medium text-[var(--fg)] truncate">
                        ...
                        {f.is_public && <span className="ml-2 text-sm text-[#00ff88] align-middle">● 對外公開中</span>}
                      </p>
                  ...
                  <div className="flex gap-2 shrink-0 flex-wrap">
                    {canPublish && !f.is_public && (
                      <button
                        ...
                        className="text-sm font-mono uppercase tracking-wider border border-[#00d4ff]/60 text-[#00d4ff] bg-transparent px-2.5 py-1 cyber-chamfer-sm hover:bg-[#00d4ff] hover:text-[#0a0a0f] transition"
                      >
                        設為對外公開版本
                      </button>
                    )}
                    {canManage && (
                      <>
                        <button onClick={() => startEdit(f)} className="text-sm font-mono uppercase tracking-wider border border-[var(--border)] text-[var(--fg)] bg-transparent px-2.5 py-1 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] transition">編輯</button>
                        <button
                          onClick={() => { if (window.confirm('確定要刪除這個版本嗎？')) onDelete(f.id); }}
                          className="text-sm font-mono uppercase tracking-wider border-2 border-[#ff3366]/50 text-[#ff3366] bg-transparent px-2.5 py-1 cyber-chamfer-sm hover:bg-[#ff3366] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#ff3366,0_0_10px_#ff336640] transition"
                        >
                          刪除
                        </button>
                      </>
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-5 ">
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        ...
        {canManage && (
          <button onClick={onAdd} className="flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider border-2 border-[#00ff88] text-[#00ff88] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition">
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-5 ">
      <div className="flex items-center justify-between mb-4 flex-wrap gap-2">
        ...
        {canEdit && !editing && (
          <button onClick={() => setEditing(true)} className="text-sm font-mono uppercase tracking-wider border-2 border-[#00ff88] text-[#00ff88] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition">
            編輯文章
          </button>
        )}
      </div>
      {editing ? (
        <div className="space-y-3 mb-4">
          ...
          />
          <div className="flex gap-2">
            <button onClick={save} disabled={saving} className="flex-1 border-2 border-[#00ff88] text-[#00ff88] bg-transparent text-base font-mono uppercase tracking-wider py-2 cyber-chamfer-sm disabled:opacity-40 hover:bg-[#00ff88] hover:text-[#0a0a0f] transition">
              {saving ? '儲存中...' : '儲存文章'}
            </button>
            <button
...
function InstructorHandout({ files }) {
  ...
  return (
    <div className="bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-5 ">
      ...
      <div className="relative bg-[var(--muted)] border border-[var(--border)] text-[var(--fg)] cyber-chamfer-sm p-6 min-h-[220px] overflow-hidden mb-4">
        <p className="text-base leading-relaxed text-[var(--fg)] relative z-0">
          {published ? (published.note || '此方塊美編講義已就緒，請點擊下方按鈕開啟。') : '教材總監尚未指定要對外公開的美編講義版本。'}
        </p>
        <Watermark />
      </div>
      {published ? (
        <a
          href={published.file_url}
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-center gap-2 border-2 border-[#00ff88] text-[#00ff88] bg-transparent text-base font-mono uppercase tracking-wider py-2.5 cyber-chamfer-sm hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition"
        >
          <ExternalLink className="w-4 h-4" /> 開啟 Google Drive 講義
        </a>
      ) : (
        <p className="text-base text-[var(--mutedFg)] text-center">尚無可下載的講義連結</p>
      )}
    </div>
  );
}
      ...
      <div className="bg-[var(--card)] border border-[var(--border)] cyber-chamfer w-full max-w-md p-6 shadow-[0_0_30px_rgba(0,255,136,0.15)]" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={onClose}>
            <X className="w-5 h-5 text-[var(--mutedFg)] hover:text-[#00ff88]" />
          </button>
        </div>
              ...
              {pending.map((u) => (
                <div key={u.id} className="bg-[#ff00ff]/10 border border-[#ff00ff]/40 cyber-chamfer p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <button onClick={() => onSetRole(u, 'general_instructor')} className="text-sm font-mono uppercase tracking-wider border border-[var(--border)] text-[var(--fg)] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] transition">設為一般講師</button>
                    <button onClick={() => onSetRole(u, 'internal_partner')} className="text-sm font-mono uppercase tracking-wider border border-[var(--border)] text-[var(--fg)] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] transition">設為內部夥伴</button>
                    <button onClick={() => onSetRole(u, 'admin')} className="text-sm font-mono uppercase tracking-wider border border-[var(--border)] text-[var(--fg)] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] transition">設為管理者</button>
                  </div>
                </div>
              ))}
            </div>
  ...
  return (
    <div className="theme-dark min-h-screen bg-[var(--bg)] cyber-scanlines cyber-grid-bg flex items-center justify-center p-6" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <button onClick={onLogout} className="text-base font-mono text-[var(--mutedFg)] hover:text-[#00ff88] hover:underline">登出</button>
      </div>
    </div>
  );
}
...
function LearningMapCubeButton({ name, brokenImages, setBrokenImages, onOpenCube }) {
  ...
  return (
    <button
      ...
      title={name}
    >
      <div className="relative w-16 h-16 sm:w-20 sm:h-20 bg-[var(--muted)] border border-[var(--border)] cyber-chamfer-sm overflow-hidden group-hover:border-[#00ff88] group-hover:shadow-[0_0_8px_#00ff8860] transition">
        {imgUrl && !brokenImages[key] ? (
          ...
          <div className="w-full h-full flex items-center justify-center">
            <Box className="w-7 h-7 text-[var(--mutedFg)]" />
          </div>
        )}
      ...
      <span className="text-sm font-mono text-[var(--mutedFg)] group-hover:text-[var(--fg)] transition max-w-[5.5rem] truncate">{name}</span>
    </button>
  );
}
    ...
    <div className="relative w-full bg-[var(--card)] border border-[var(--border)] cyber-chamfer shadow-[0_0_20px_rgba(0,255,136,0.15)] p-5 sm:p-6 text-left overflow-hidden">
      ...
      <div className="relative">
        <div className="flex items-center gap-3 mb-5">
          <div className="bg-[#00ff88] text-[#0a0a0f] px-3 py-1.5 cyber-chamfer-sm font-mono uppercase tracking-wider text-lg font-bold">
            魔術方塊學習地圖
          </div>
          <span className="text-base text-[var(--mutedFg)] font-mono uppercase tracking-wide">學習地圖</span>
          <div className="flex-1 h-px bg-[var(--border)]" />
        </div>

        {/* 手機版寬度不夠時，這一塊改成左右滑動，不會把方塊擠成一團 */}
              ...
              {LEARNING_MAP_ROWS.map((row) => (
                <div key={row.label} className="flex gap-3 items-start">
                  <div className="w-24 shrink-0 pt-2">
                    <p className="text-base font-mono uppercase tracking-wide text-[var(--fg)] leading-tight">{row.label}</p>
                  </div>
                  {row.groups.map((g, i) => (
                    <div
                      key={g.months}
                    ...
                    >
                      {g.cubes.length === 0 ? (
                        <span className="text-base text-[var(--mutedFg)] font-mono">－</span>
                      ) : (
                        g.cubes.map((name) => (
            ...
            <div className="relative h-8 mt-6 mb-2 ml-24">
              ...
              {RANK_MARKERS.map((m) => (
                <div key={m.label} className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col items-center" style={{ left: `${m.pos}%` }}>
                  ...
                  <span className="text-sm font-mono text-[var(--fg)] mt-1 whitespace-nowrap">{m.label}</span>
                </div>
              ))}
            </div>
          </div>
...
function ContentOverviewPanel({ cubeStatusMap, onOpenCube }) {
  ...
  return (
    <div className="w-full bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-5 sm:p-6 text-left mb-8">
      <div className="flex items-center justify-between flex-wrap gap-3 mb-4">
        <h3 className="font-semibold text-[var(--fg)] uppercase tracking-wide font-mono text-lg flex items-center gap-2">
          <LayoutDashboard className="w-5 h-5 text-[#00ff88]" /> 教材總覽
        </h3>
        <select
          value={filter}
          onChange={(e) => setFilter(e.target.value)}
          className="bg-[var(--muted)] border border-[var(--border)] cyber-chamfer-sm px-3 py-2 text-base text-[var(--fg)] font-mono focus:outline-none focus:ring-2 focus:ring-[#00ff88]"
        >
      ...
      {filtered.length === 0 ? (
        ...
        <div className="flex flex-wrap gap-2">
          {filtered.map((c) => (
            <button
              key={c.name}
              onClick={() => onOpenCube({ id: `${c.tier.score}__${c.name}`, name: c.name, tier: c.tier })}
              className="flex items-center gap-2 text-sm font-mono border border-[var(--border)] text-[var(--fg)] bg-[var(--muted)] px-3 py-1.5 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] transition"
            >
      ...
      <p className="text-sm text-[var(--mutedFg)] font-mono mt-3">共 {filtered.length} / 31 顆符合</p>
    </div>
  );
}
  ...
  return (
    <div className={`theme-${theme || 'dark'} min-h-screen bg-[var(--bg)] relative overflow-hidden flex items-center justify-center p-6`} style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      <div className="w-full max-w-6xl text-center relative px-2">
        <h1 style={{ fontFamily: "'Orbitron', sans-serif", textShadow: '0 0 10px rgba(0,255,136,0.5)' }} className="text-2xl sm:text-3xl md:text-5xl font-black text-[#00ff88] uppercase tracking-wide md:tracking-widest mb-2 cyber-glitch break-words">
          夢想一號魔術方塊學院
        </h1>
        <p
          style={{ fontFamily: "'Orbitron', sans-serif" }}
          className="text-xl sm:text-2xl md:text-4xl lg:text-6xl font-black uppercase tracking-wide md:tracking-widest text-white mb-6 cyber-rgb-shift cyber-glitch break-words"
        >
          全宇宙最完整的教材系統
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 mb-8">
          <span className="text-xs sm:text-sm md:text-base font-mono uppercase tracking-wide bg-[#ff3366]/10 text-[#ff3366] border border-[#ff3366]/50 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full">🧩 31 種方塊教材</span>
          <span className="text-xs sm:text-sm md:text-base font-mono uppercase tracking-wide bg-[#ffee00]/10 text-[#ffee00] border border-[#ffee00]/50 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full">🎯 6 個認證等級</span>
          <span className="text-xs sm:text-sm md:text-base font-mono uppercase tracking-wide bg-[#00d4ff]/10 text-[#00d4ff] border border-[#00d4ff]/50 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full">👩‍🏫 專業師資審核</span>
        </div>

        {(role === 'admin' || role === 'internal_partner') && (
          <ContentOverviewPanel cubeStatusMap={cubeStatusMap} onOpenCube={onOpenCube} />
        )}
    ...
    <div className={`theme-${theme || 'dark'} min-h-screen bg-[var(--bg)] cyber-scanlines cyber-grid-bg flex items-center justify-center p-6`} style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      <div className="w-full max-w-2xl">
        ...
        <button
          onClick={submit}
          disabled={saving}
          className="w-full border-2 border-[#00ff88] text-[#00ff88] bg-transparent cyber-chamfer font-mono uppercase tracking-wider text-2xl py-5 disabled:opacity-40 hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition"
        >
          {saving ? '儲存中...' : '儲存並繼續'}
        </button>
        {mode === 'edit' && onCancel && (
          <button onClick={onCancel} className="w-full text-[var(--mutedFg)] hover:text-[#00ff88] text-xl font-mono py-4 transition">
            返回
          </button>
        )}
        {mode === 'setup' && onBack && (
          <button onClick={onBack} className="w-full text-[var(--mutedFg)] hover:text-[#00ff88] text-xl font-mono py-4 transition">
            返回登入頁面
          </button>
        )}
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between gap-4 flex-wrap">
        ...
        <div className="flex items-center gap-3">
          ...
          {role === 'admin' && (
            <button
              onClick={onOpenAdmin}
              className="flex items-center gap-1.5 text-sm font-mono uppercase tracking-wider border border-[var(--border)] text-[var(--fg)] bg-transparent px-3 py-1.5 cyber-chamfer-sm hover:border-[#00ff88] hover:text-[#00ff88] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition"
            >
  ...
  return (
    <div className={`theme-${theme} min-h-screen bg-[var(--bg)] text-[var(--fg)]`} style={{ fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        {view === 'dashboard' && (
          <div>
            <h1 style={{ fontFamily: "'Orbitron', sans-serif" }} className="text-3xl font-black mb-1 text-[var(--fg)] uppercase tracking-widest">
              綜合能力認證分數地圖
            </h1>
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <p className="font-semibold text-[var(--fg)] uppercase tracking-wide font-mono">{tier.score}分方塊區</p>
        ...
        {view === 'cube' && selectedCube && (
          <div>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4 bg-[var(--card)] border border-[var(--border)] cyber-chamfer p-6 mb-6 ">
              <div className="flex items-center gap-4">
                <div
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--mutedFg)]">認證分數 {selectedCube.tier.score} 分・{selectedCube.tier.score}分方塊區</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                {role === 'admin' && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 border border-[var(--border)] text-[var(--fg)] bg-transparent text-base font-mono uppercase tracking-wider px-4 py-2.5 cyber-chamfer hover:border-[#00ff88] hover:text-[#00ff88] transition"
                    >
                ...
                {role === 'general_instructor' && (
                  <button
                    ...
                    className="flex items-center gap-1.5 border-2 border-[#00ff88] text-[#00ff88] bg-transparent text-base font-mono uppercase tracking-wider px-4 py-2.5 cyber-chamfer hover:bg-[#00ff88] hover:text-[#0a0a0f] hover:shadow-[0_0_5px_#00ff88,0_0_10px_#00ff8840] transition"
                  >
